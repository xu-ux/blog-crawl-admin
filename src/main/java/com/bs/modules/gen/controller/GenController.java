package com.bs.modules.gen.controller;
...
import com.bs.common.web.domain.response.module.ResultSelect;
...
import com.bs.modules.gen.service.IGenTableColumnService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        String fileName = DateUtil.format(new Date(), DatePattern.PURE_DATE_PATTERN).concat("_genCode.zip");
